            ...
            <div className="col-xl-3 col-lg-6 col-md-6">
                ...
                <figure className="fig_home" style={{backgroundImage:propsimg==="(-)"?`url(${nopicture})`:"url(http://pearltravels.in/"+propsimg+")",backgroundSize:"cover",backgroundPosition:"center" }}>
                        <div className="grid---content">
                            ...
                            <div className="info--p">Explore {props.placename} collection with {propspack} package
                            <Link to={`/destination/${props.placename}`} style={{textDecoration:"none"}}><div className="read-more">Detail</div></Link></div>
                        </div>
                    </figure>
                </div>
            </div>
