...
exports.default = exports.name = exports.version = exports.buildAuthenticatedRouter = exports.buildRouter = void 0;
const buildRouter_1 = __importDefault(require("./buildRouter"));
exports.buildRouter = buildRouter_1.default;
const buildAuthenticatedRouter_1 = __importDefault(require("./buildAuthenticatedRouter"));
exports.buildAuthenticatedRouter = buildAuthenticatedRouter_1.default;
...
exports.name = name;
const defaultExport = {
    buildRouter: buildRouter_1.default,
    buildAuthenticatedRouter: buildAuthenticatedRouter_1.default,
    version,
    name,
};
