...
declare const name = "AdminBroKoa";
declare const defaultExport: {
    buildRouter: (admin: import("admin-bro/types/src/admin-bro").default, app: import("koa")<import("koa").DefaultState, import("koa").DefaultContext>, predefinedRouter?: import("@koa/router")<any, {}> | undefined, formidableOptions?: any) => import("@koa/router")<any, {}>;
    buildAuthenticatedRouter: (admin: import("admin-bro/types/src/admin-bro").default, app: import("koa")<import("koa").DefaultState, import("koa").DefaultContext>, auth: import("./types").KoaAuthOptions, predefinedRouter?: import("@koa/router")<any, {}> | undefined, formidableOptions?: any) => import("@koa/router")<any, {}>;
    version: any;
    name: string;
};
export { buildRouter, buildAuthenticatedRouter, version, name, defaultExport as default, };
