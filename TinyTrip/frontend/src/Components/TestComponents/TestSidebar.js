...
function sidebar(props) {
  ...
  function handleInputChange(telNumber, selectedCountry) {
    document
      ...
      .setAttribute("format", selectedCountry.format);
  ...
  propspricing =
    typeof pricing === "undefined" || pricing === 0
      ? propspricing.toLowerCase().replace(" ", "").split("from")
      : pricing === ""
  ...
  const night =
    typeof propsinfo.split("-")[1] === "undefined"
      ? ""
      : propsinfo.split("-")[1].replace(" ", "");
  ...
  function validate(e) {
    ...
    if (
      /^[A-Za-z\s]+$/.test(document.forms["Enquiry"]["Name"].value.trim()) ===
      false
    ) {
      return addToast(
    ...
    if (
      /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(
        document.forms["Enquiry"]["email"].value.trim()
      ) === false
    ) {
    ...
    if (
      document.forms["Enquiry"]["mobile"].value.trim().length !==
      document
        .querySelector(
          ".react-tel-input input[type='text'], .react-tel-input input[type='tel']"
        )
        .getAttribute("format").length
    ) {
      return addToast(
        `Please enter a valid Phone Number as format ${document
          .querySelector(
            ".react-tel-input input[type='text'], .react-tel-input input[type='tel']"
          )
          .getAttribute("format")}`,
    ...
    if (document.forms["Enquiry"]["date"].value === "") {
      return addToast(`Date can't be blank`, {
        appearance: "error",
        autoDismiss: true,
      });
    }
    ...
    if (
      ...
      return addToast("Please enter a Date as dd/mm/yyyy", {
        appearance: "error",
        autoDismiss: true,
      });
    }
  ...
  return (
    <div id="en-form" style={{ width: "100%" }}>
      <div className="box_detail " style={{ padding: "0px", margin: "0" }}>
        ...
        <div className="Package-right-side">
          <p className="fl row">
            ...
            2 Days <span className="line-1"></span>{" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
            ...
            2 Nights <span className="line-1"></span>
            {/* <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div className="price" style={{ margin: "0px" }}>
          <div className="row">
            {/* <div
              style={{
                borderBottom: "none",
              ...
              className="col-md-12 price"
            >
              <div className="cl"></div>
              <span style={{}}>{propspricing}</span>
              <br />
              <div className="cl"></div>
              <span
                style={{
            ...
            <form
              name="Enquiry"
              className="package_rate_enquiry container"
              autoComplete="off"
            >
              <div className="container pl-con">
                        ...
                        >
                          ...
                          <div className="form-group">
                            <input
                              ...
                              onChange={handleChange}
                              className="form-control"
                              placeholder="Number Of Adults (15+ Years)"
                          ...
                          <div className="form-group">
                            <input
                              ...
                              onChange={handleChange}
                              className="form-control"
                              placeholder="Number Of Children (2-14 Years)"
                              style={{ marginTop: "1rem" }}
                            />
                          </div>
                          <div className="form-group">
                            <input
                              ...
                              onChange={handleChange}
                              className="form-control"
                              placeholder="Number Of Infant (0-2 Years)"
                              style={{ marginTop: "1rem" }}
                            />
                          </div>
                        </div>
                ...
                <button
                  onClick={validate}
                  className="btn_1 full-width wishlist sending1 "
                  style={{ background: "#023e8a" }}
                >
                  <i className="fal fa-book" aria-hidden="true"></i> Send
                  Enquiry{" "}
                </button>
              </div>
            </form>
          ...
          <ul className="share-buttons">
            ...
            >
              ...
              <a
                className="st-btn-whatsaap"
                style={{ display: "inline-block", cursor: "pointer" }}
                href={`https://wa.me/+${state.wpNo}/`}
                target="_blank"
              >
                <img
                  alt="whatsaap sharing button"
              ...
              >
                ...
                >
                  ...
                  />
                  <span className="st-label" style={{ cursor: "pointer" }}>
                    {" "}
                    Share
                  </span>
                </div>
