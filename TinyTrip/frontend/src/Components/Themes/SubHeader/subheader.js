      ...
      <div className="filters_listing sticky_horizontal">
        <div className="container">
          <div className="row showDisplayingOutOff">
            <div className="col-lg-3 filter_type ">
              <h6
                className="nomargin_top ng-binding"
                style={{ paddingTop: "0px", border: "none", margin: "10px 0" }}
              >
                Displaying {this.props.pd} out of {this.props.pn} {type}(s)
              </h6>
            </div>
          </div>
