    ...
    <div>
      ...
      <div style={{ height: "85vh" }}>
        <img
          ...
          alt="slider1"
        />
        {/* <a href={"https://unsplash.com/s/photos/"+destinationName.toLowerCase().trim().replace(' ','-')} target="_blank" className="btn_photos" title="Pictures" style={{textDecoration:"none"}}>View photos</a> */}
      </div>
